...
Zany（疯癫）对应生产。它是一种关于表演、忙碌、多工、情感劳动以及持续适应的审美。疯癫的人始终在工作、娱乐、协调与表演。`
  ...
  },
  {
    ...
    quotes: [
      ...
      {
        en: "Whether or not he was ‘worth it’ is of no consequence.",
        zh: "他是否‘值得’已经没有任何意义。"
      },
      {
        en: "I haven't written a book about him, neither have I written a book about myself. All I have done is translate into words the way in which his existence has affected my life.",
        zh: "我写的不是一本关于他的书，甚至也不是一本关于我自己的书。我所做的，只是把他的存在如何影响了我的生命转化为文字。"
      }
    ],
