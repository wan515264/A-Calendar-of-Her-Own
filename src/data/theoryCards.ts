...
export const theoryCards: TheoryCard[] = [
  ...
  {
    id: '2026-07-11-patricia-hill-collins',
    date: '2026-07-11',
    cardType: 'classic-text',
    cardTitle: 'Black Feminist Thought',
    cardTitleZh: '《黑人女性主义思想》',
    thinkerId: 'patricia-hill-collins',
    thinkerName: 'Patricia Hill Collins',
    thinkerNameZh: '帕特里夏·希尔·柯林斯',
    birthDeath: '1948-',
    concept: 'Matrix of Domination',
    conceptZh: '支配矩阵',
    tags: ['intersectionality', 'gender', 'decolonial feminism'],
    quote: 'Paraphrased idea: race, gender, class, and sexuality organize power through interlocking systems.',
    quoteSource: 'Paraphrased from Black Feminist Thought',
    explanationEn: 'Collins offers a framework for seeing oppression as interconnected rather than separate single-axis categories.',
    explanationZh: '柯林斯提供了理解压迫相互交织的框架，而不是把压迫拆成彼此孤立的单一轴线。',
    reflectionQuestion: 'Which intersecting structures shape the room you are in today?',
    relatedWorks: ['Black Feminist Thought', 'Intersectionality as Critical Social Theory']
  },
  {
    id: '2026-07-12-chandra-mohanty',
    date: '2026-07-12',
    thinkerId: 'chandra-talpade-mohanty',
    thinkerName: 'Chandra Talpade Mohanty',
    thinkerNameZh: '钱德拉·塔尔帕德·莫汉蒂',
    birthDeath: '1955-',
    concept: 'Transnational Feminist Solidarity',
    conceptZh: '跨国女性主义团结',
    tags: ['decolonial feminism', 'labor', 'gender'],
    quote: 'Paraphrased idea: solidarity is built through historical specificity, not through universal sisterhood.',
    quoteSource: 'Paraphrased from Feminism Without Borders',
    explanationEn: 'Mohanty critiques Western feminist generalizations and asks for feminist politics grounded in material histories.',
    explanationZh: '莫汉蒂批判西方女性主义的概括化叙事，主张从具体历史与物质处境中建立女性主义政治。',
    reflectionQuestion: 'How can solidarity begin with difference rather than erase it?',
