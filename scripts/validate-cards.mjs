...
const allowedTypes = new Set(['thinker', 'writer', 'artist', 'photographer', 'concept', 'text', 'quote', 'debate', 'criticism', 'theory', 'performance', 'installation', 'sculpture', 'novel', 'book']);
